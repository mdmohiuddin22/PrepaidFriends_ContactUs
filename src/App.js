    ...
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route
          ...
          element={<PortfolioDetailTwo />}
        />
        <Route
          exact
          path="/portfolio-detail-three"
          element={<PortfolioDetailThree />}
        />
        <Route
          exact
          path="/portfolio-detail-one"
          element={<PortfolioDetailOne />}
        />
        <Route
          exact
          path="/portfolio-detail-four"
          element={<PortfolioDetailFour />}
        />
        <Route
          exact
          path="/portfolio-creative-two"
          element={<PortfolioCreativeTwo />}
        />
        <Route
          exact
          path="/portfolio-creative-three"
          element={<PortfolioCreativeThree />}
        />
        <Route
          exact
          path="/portfolio-creative-six"
          element={<PortfolioCreativeSix />}
        />
        <Route
          exact
          path="/portfolio-creative-four"
          element={<PortfolioCreativeFour />}
        />
        <Route
          exact
          path="/portfolio-creative-five"
          element={<PortfolioCreativeFive />}
        />
        <Route
          exact
          path="/portfolio-classic-two"
          element={<PortfolioClassicTwo />}
        />
        <Route
          exact
          path="/portfolio-classic-three"
          element={<PortfolioClassicThree />}
        />
        <Route
          exact
        ...
        <Route
          ...
          element={<PortfolioClassicSix />}
        />
        <Route
          exact
          path="/portfolio-classic-four"
          element={<PortfolioClassicFour />}
        />
        <Route
          exact
          path="/portfolio-classic-five"
          element={<PortfolioClassicFive />}
        />
        ...
        <Route
          ...
          element={<PageJobCompanyDetail />}
        />
        <Route
          exact
          path="/page-job-company-detail/:id"
          element={<PageJobCompanyDetail />}
        />
        <Route
          exact
          path="/page-job-companies"
          element={<PageJobCompanies />}
        />
        <Route exact path="/page-job-career" element={<PageJobCareer />} />
        <Route
          exact
          path="/page-job-candidates"
          element={<PageJobCandidates />}
        />
        <Route
          exact
          path="/page-job-candidate-detail"
          element={<PageJobCandidateDetail />}
        />
        <Route
          exact
          path="/page-job-candidate-detail/:id"
          element={<PageJobCandidateDetail />}
        />
        ...
        <Route
          exact
          path="/index-phone-number"
          element={<IndexPhoneNumber />}
        />
        ...
        <Route
          ...
          element={<IndexLandingThree />}
        />
        <Route exact path="/index-landing-one" element={<IndexLandingOne />} />
        <Route
          exact
          path="/index-landing-four"
          element={<IndexLandingFour />}
        />
        <Route
          exact
          path="/index-landing-five"
          element={<IndexLandingFive />}
        />
        <Route exact path="/index-it-solution" element={<IndexItSolution />} />
        <Route
          exact
          path="/index-it-solution-two"
          element={<IndexItSolutionTwo />}
        />
        ...
        <Route
          ...
          element={<PortfolioModernTwo />}
        />
        <Route
          exact
          path="/portfolio-modern-three"
          element={<PortfolioModernThree />}
        />
        <Route
          exact
          path="/portfolio-modern-six"
          element={<PortfolioModernSix />}
        />
        <Route
          exact
          path="/portfolio-modern-four"
          element={<PortfolioModernFour />}
        />
        <Route
          exact
          path="/portfolio-modern-five"
          element={<PortfolioModernFive />}
        />
        <Route
          exact
          path="/portfolio-masonry-two"
          element={<PortfolioMasonryTwo />}
        />
        <Route
          exact
          path="/portfolio-masonry-three"
          element={<PortfolioMasonryThree />}
        />
        <Route
          exact
          path="/portfolio-masonry-six"
          element={<PortfolioMasonrySix />}
        />
        <Route
          exact
          path="/portfolio-masonry-four"
          element={<PortfolioMasonryFour />}
        />
        <Route
          exact
          path="/portfolio-masonry-five"
          element={<PortfolioMasonryFive />}
        />
        ...
        <Route
          exact
          path="/nft-creator-profile/:id"
          element={<NftCreatorProfile />}
        />
        <Route
          exact
          path="/nft-creator-profile"
          element={<NftCreatorProfile />}
        />
        <Route
          exact
          path="/nft-creator-profile-edit"
          element={<NftCreatorProfileEdit />}
        />
