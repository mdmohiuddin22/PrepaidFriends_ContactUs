...
export default function PageAboutus() {
    ...
    const features = [
        ...
        {icon:Icon.Monitor, title:"Easy to customize"},
    ]
    const teamData = [
        {
            image:image,
                ...
                <div className="container relative">
                    ...
                    <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-[30px] mt-8">
                        {features.map((item,index)=>{
                            ...
                            return(
                                <div key={index} className="flex transition-all duration-500 hover:scale-105 shadow dark:shadow-gray-800 hover:shadow-md dark:hover:shadow-gray-700 ease-in-out items-center p-3 rounded-md bg-white dark:bg-slate-900">
