...
import image12 from '../assets/images/food/1.jpg';
import image13 from '../assets/images/food/2.jpg';
import image14 from '../assets/images/food/3.jpg';
import image15 from '../assets/images/food/4.jpg';
import image16 from '../assets/images/food/5.jpg';
import image17 from '../assets/images/food/6.jpg';
import image18 from '../assets/images/food/7.jpg';
import image19 from '../assets/images/food/8.jpg';
import image20 from '../assets/images/food/9.jpg';
import image21 from '../assets/images/food/10.jpg';
import image22 from '../assets/images/food/11.jpg';
import image23 from '../assets/images/food/12.jpg';
import image24 from '../assets/images/food/13.jpg';
import image25 from '../assets/images/food/14.jpg';
import image26 from '../assets/images/food/15.jpg';
...
import {MdOutlineCalendarMonth,LuCalendarDays} from "../assets/icons/icons"
...
export default function FoodRecipe() {
    ...
    const id = params.id
    const data = foodBlogData.find((blog) => blog.id === parseInt (id));

    const [isOpen, setOpen] = useState(false)
    const [lightBox, setLightbox] = useState(false);
    const [currentImageIndex, setCurrentImageIndex] = useState(0);
    const images = [image12,image13,image14,image15,image16,image17,image18,image19,image20,image21,image22,image23,image24,image25,image26]
                                    ...
                                    <div className="card border-0 rounded-0">
                                        <div className="card-body p-0">
                                            <Link onClick={() => handleImageClick(index)} className="lightbox d-inline-block" title="">
                                                <img src={item.image} className="" alt="Insta Post" />
