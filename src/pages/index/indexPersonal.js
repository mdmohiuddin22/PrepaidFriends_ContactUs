...
import {FaArrowRight ,FaRegComment, HiOutlineCog6Tooth, MdApi, FiAirplay,FiCamera, TbCameraPlus, PiFlowerLight } from '../../assets/icons/icons'

export default function IndexPersonal() {
    const [isOpen, setOpen] = useState(false);  const [currentImageIndex, setCurrentImageIndex] = useState(0);
