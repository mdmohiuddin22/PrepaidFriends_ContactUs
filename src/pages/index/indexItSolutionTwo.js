...
import about from '../../assets/images/it/about.jpg';
...
import {BiLineChart, LiaCrosshairsSolid, FiAirplay, GoRocket, GoClock,LuUsers, FiFileText, LuSearch, MdOutlineEventNote} from '../../assets/icons/icons'
...
export default function IndexItSolutionTwo() {
    ...
    return (
        <>
            ...
            <section className="py-28 w-full table relative bg-[url('../../assets/images/cta.jpg')] bg-center bg-no-repeat bg-cover">
