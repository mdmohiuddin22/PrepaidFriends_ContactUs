...
import {BiWater, LiaDropbox, MdCenterFocusWeak, RiPresentationFill, LiaFileInvoiceDollarSolid, LiaMoneyCheckAltSolid, AiOutlineDollar, FaRegEnvelope, FaArrowRight} from '../../assets/icons/icons'
            ...
            <section className="py-20 w-full table relative bg-[url('../../assets/images/digital/bg01.jpg')] bg-center bg-no-repeat bg-cover">
                ...
                <div className="container relative">
                    <div className="grid grid-cols-1 text-center">
                        ...
                        <Link to="#" onClick={() => setOpen(true)} data-type="youtube" data-id="S_CGed6E610" className="lightbox h-20 w-20 rounded-full shadow-md dark:shadow-gray-800 inline-flex items-center justify-center bg-white dark:bg-slate-900 text-indigo-600 mx-auto mt-10">
