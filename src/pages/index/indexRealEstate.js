...
import {FaArrowRight, LuSearch, LuBath, AiOutlineHome,AiOutlineDollar,PiBriefcase, FiKey, LiaCompressArrowsAltSolid, LuBedDouble, FiPhone } from '../../assets/icons/icons'
            ...
            <section className="relative md:pb-24 pb-16">
                ...
                <div className="container relative md:mt-24 mt-16">
                    <div className="grid grid-cols-1 text-center">
                        ...
                        <div className="mt-6">
                            <Link to="/contact" className="py-2 px-5 inline-flex items-center font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-md"><FiPhone className="me-1 text-lg"/>  Contact us</Link>
                        </div>
                    </div>
                </div>
            </section>
