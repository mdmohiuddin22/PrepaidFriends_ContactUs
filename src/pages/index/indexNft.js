...
import image16 from '../../assets/images/nft/items/16.jpg';
import image17 from '../../assets/images/nft/items/1.jpg';
import image18 from '../../assets/images/nft/items/2.jpg';
import image19 from '../../assets/images/nft/items/3.jpg';
import image20 from '../../assets/images/nft/items/17.jpg';
import image21 from '../../assets/images/nft/items/4.jpg';
import image22 from '../../assets/images/nft/items/5.jpg';
import image23 from '../../assets/images/nft/items/6.jpg';
import image24 from '../../assets/images/client/02.jpg';
import image25 from '../../assets/images/nft/items/18.jpg';
import image26 from '../../assets/images/nft/items/7.jpg';
import image27 from '../../assets/images/nft/items/8.jpg';
import image28 from '../../assets/images/nft/items/9.jpg';
import image29 from '../../assets/images/client/03.jpg';
...
import {BiWallet,LuImagePlus, LuSave, FaArrowRight, GoClock} from '../../assets/icons/icons'
    ...
    const collection = [
        {
            title:"Digital Arts",
            mainImage:image16,
            subImage:[image17, image18, image19],
            teamImage:image,
        },
        {
            title:"Digital Arts",
                          ...
                          {collection.map((item,index)=>{
                            return(
                                <div key={index} className="group relative overflow-hidden bg-gray-50 dark:bg-slate-800 rounded-md shadow dark:shadow-gray-800">
                                    <div className="p-2 rounded-md shadow dark:shadow-gray-800 bg-gradient-to-br to-orange-600/20 via-fuchsia-600/20 from-indigo-600/20">
                                        <div className="flex items-center">
                                            <div className="w-full p-1">
                                                <img src={item.mainImage} className="rounded-md" alt="" />
                                            </div>
                                        </div>
                                    ...
                                    <div className="p-6 pt-0 -mt-10 text-center">
                                        <img src={item.teamImage} className="h-20 w-20 rounded-full shadow-lg dark:shadow-gray-800 mx-auto" alt="" />

                                        <div className="mt-4">
                                            <Link  className="text-xl leading-none font-semibold hover:text-indigo-600 duration-500 ease-in-out block">{item.title}</Link>
                                        </div>
                                    </div>
                                </div>
                            )
