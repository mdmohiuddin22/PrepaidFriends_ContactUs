...
import image1 from '../../assets/images/client/9.png';
import image2 from '../../assets/images/client/10.png';
import image3 from '../../assets/images/client/11.png';
import image4 from '../../assets/images/client/12.png';
import image5 from '../../assets/images/client/13.png';
import image6 from '../../assets/images/client/14.png';
                ...
                <div className="container relative md:mt-24 mt-16">
                    <div className="grid md:grid-cols-6 grid-cols-2 justify-center gap-[30px]">
                        <div className="mx-auto py-4">
                            <img src={image1} className="h-20" alt="" />
                        </div>

                        <div className="mx-auto py-4">
                            <img src={image2} className="h-20" alt="" />
                        </div>

                        <div className="mx-auto py-4">
                            <img src={image3} className="h-20" alt="" />
                        </div>

                        <div className="mx-auto py-4">
                            <img src={image4} className="h-20" alt="" />
                        </div>

                        <div className="mx-auto py-4">
                            <img src={image5} className="h-20" alt="" />
                        </div>

                        <div className="mx-auto py-4">
                            <img src={image6} className="h-20" alt="" />
                        </div>
                    </div>
                </div>
