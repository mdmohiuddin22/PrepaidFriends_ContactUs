...
export default function UserProfile() {
  ...
  const experienceData = [
    {image:circle_logo, title:"Senior Web Developer", time:"3 Years Experience", name:"CircleCi", location:"@London, UK"},
    {image:facebook_logo_2019, title:"Web Designer", time:"2 Years Experience", name:"Facebook", location:"@Washington D.C, USA"},
    {image:spotify, title:"UI Designer", time:"2 Years Experience", name:"Spotify", location:"@Perth, Australia"},
  ]
  return (
    <>
